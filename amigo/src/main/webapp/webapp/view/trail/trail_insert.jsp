...
<body>
	...
	<%@include file="/includes/header.jsp" %>
		<div class="container">
			    ...
			    <form id="form" action="insertTrailReview.do" method="post" role="form" class="reviewform container">
			        ...
			        <div class="review_contents">
			            ...
			            <div class="cmd">
            			    <input class="btn btn-primary" type="button" name="save" id="save" value="등록">
            			</div>
			    </form>   
