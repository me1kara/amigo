...
<body>
	...
	<div class="container mt-3" align="center">
		<form action="cs_board_update.do" method="post" >
		
			<input name="hbd_no" type="hidden" value="${csboard.getHbd_no()}" />
			...
			<div class="input-group mb-3">
				<!-- 글제목 -->
  				...
  				<label for="hbd_title" class="col-md-1 control-label" style="font-size:18px; font-weight:bold;" >글제목&nbsp;</label>
  				<div class="col">
  				<input type="text" class="form-control" name="hbd_title" id="hbd_title" value="${ csboard.getHbd_title() }">
  				</div>  			 
  				<!-- 글제목 끝 -->
			</div>
			...
			<div class="input-group mb-3">
			   <textarea class="form-control" id="hbd_cont" name="hbd_cont" rows="15" required >${ csboard.getHbd_cont() }</textarea>		 
			</div>	
			...
			<input type="hidden" name="hbd_file" value="${csboard.getHbd_file()}"/>
