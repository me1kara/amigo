    ...
    <div class="container">
      ...
      >
        ...
        <c:choose>
          	...
          	<img src="/userimg/${user.getUser_photo()}" style="border-radius:50px;" alt="userphoto" width="50px" height="50px" style="border-radius:10px" />
            </c:when>
            <c:otherwise>
            <img src="../../resources/img/logo2.png" style="border-radius:50px;" alt="logo2" width="50px" height="50px"/>
            </c:otherwise>
          </c:choose>
