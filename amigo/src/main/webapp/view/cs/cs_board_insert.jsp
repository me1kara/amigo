...
<body>
	...
	<form action="cs_board_insert.do" method="post"  enctype="multipart/form-data" onSubmit="return checkResult()  ">
		...
		<!-- 글제목 -->
	  	...
	  	<!-- 글제목 label로 해서 폼을 둥글게 만들어줌. -->
	  		...
	  		<div class="col">
	  		<input type="text" class="form-control" name="hbd_title" id="hbd_title" required>
	  		</div>  			 
	  	<!-- 글제목 끝 -->
		</div>
		...
		<!-- 상단 끝 -->
			...
			<hr/>
		<div class="input-group mb-3">
			   <textarea class="form-control" id="hbd_cont" name="hbd_cont" rows="15" placeholder="글 내용을 입력하세요.." required ></textarea>		 
		</div>	
		  ...
		  <b>사진업로드(최대 5장/300*300)</b><br><br> 
			...
			<input type="hidden" name="hbd_file" value=""/>	
