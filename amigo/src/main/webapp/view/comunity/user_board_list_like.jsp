	...
	<div class="container" align="left">
		...
		<div class="row align-items-start mt-3">
			<ul class="col pagination justify-content-center">
				...
				<c:if test="${ lp < tp }">
					<li class="page-item "><a href="user_board_list_like.do?curPage=${lp+1}&rowSizePerPage=${rp}&searchType=${st}&searchWord=${sw}" class="page-link"><i class="fas fa-forward"></i></a></li>				
