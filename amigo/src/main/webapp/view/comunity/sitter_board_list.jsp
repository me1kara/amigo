   ...
   <div class="container col-md-6" align="left">
      ...
      <div class="row align-items-start mt-3">
         <ul class="col pagination justify-content-center">
            ...
            <c:if test="${ fp != 1 }">
               <li class="page-item"><a href="sitter_board_list.do?curPage=1&rowSizePerPage=${rp}&searchType=${st}&searchWord=${sw}" class="page-link"><i class="fas fa-fast-backward"></i></a></li>
               <li class="page-item"><a href="sitter_board_list.do?curPage=${fp-1}&rowSizePerPage=${rp}&searchType=${st}&searchWord=${sw}" class="page-link"><i class="fas fa-backward"></i></a></li>            
            </c:if>
         
            <c:forEach var="page" begin="${fp}" end="${lp}">
               <li class="page-item ${cp==page ? 'active' : ''}"><a href="sitter_board_list.do?curPage=${page}&rowSizePerPage=${rp}&searchType=${st}&searchWord=${sw}" class="page-link">${page}</a></li>
            </c:forEach>
            
            <c:if test="${ lp < tp }">
               <li class="page-item "><a href="sitter_board_list.do?curPage=${lp+1}&rowSizePerPage=${rp}&searchType=${st}&searchWord=${sw}" class="page-link"><i class="fas fa-forward"></i></a></li>            
               <li class="page-item"><a href="sitter_board_list.do?curPage=${tp}&rowSizePerPage=${rp}&searchType=${st}&searchWord=${sw}" class="page-link"><i class="fas fa-fast-forward"></i></a></li>            
            </c:if>
         </ul> <!-- pagination -->   
      	...
      	<div class="row align-items-center mt-3 mb-3">
            <div class="col-3 ms-auto mb-3">
               <select class="form-select" id="searchType" name="searchType">
                   ...
                   <option value="sbd_title" ${searchVO.getSearchType()=="sbd_title" ? "selected" : "" }>제목</option>                     
                   <option value="user_nick" ${searchVO.getSearchType()=="user_nick" ? "selected" : ""}>작성자</option>                  
                   <option value="sbd_cont" ${searchVO.getSearchType()=="sbd_cont" ? "selected" : ""}>글내용</option>                  
               </select>
            </div>
