	   		...
	   		<div class="row mt-3 justify-content-end">
	   			<div class="col-auto">
					<a href="user_board_list.do">전체글</a> 
	   				<a href="user_board_list_Like.do">상담</a> 
	   			</div>
	   		<div class="row mt-3 justify-content-end">
	   			<div class="col-auto">
					...
					function chageSelect(){ 
						...
						if(selectList.options[selectList.selectedIndex].value == "말머리"){
							location.href = "cs_board_list.do";
						}
						if(selectList.options[selectList.selectedIndex].value == "전체글"){
							location.href = "cs_board_cate.do?ubd_cate=전체";
						}
						if(selectList.options[selectList.selectedIndex].value == "상담"){
							location.href = "cs_board_cate.do?ubd_cate=상담";
						}
					}
					</script>
                ...
                <div class="card-body p-2 p-sm-3">
                  ...
                  <!-- user profile -->
                    ...
                    <div class="media-body">
                      <!-- 말머리 -->
                        <a class="text-secondary">${ board.gethbd_cate()}</a>
                      <!-- 말머리/ -->
                      <!-- 제목 -->
                      <h6>
