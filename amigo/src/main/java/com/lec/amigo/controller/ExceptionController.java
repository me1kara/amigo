 ...
 * model.addAttribute("msg", "에러발생!"); return "/view/error/error.jsp"; }
 * 
 * @ExceptionHandler(NoHandlerFoundException.class)
 * 
 * @ResponseStatus(value= HttpStatus.NOT_FOUND) public String
 * handle404(NoHandlerFoundException ex, Model model) { logger.error("404",
 * ex.getRequestURL()); model.addAttribute("msg", "해당페이지는 존재하지 않습니다"); return
 * "/view/error/error404.jsp"; } }
 */